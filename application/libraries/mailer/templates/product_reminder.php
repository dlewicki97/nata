<div style="max-width: 60%; margin: 0 auto; border: 1px solid #e2e2e2; padding: 20px; font-family: Verdana">
    ...
    <h2>Produkt '{product_name}' jest już dostępny!</h2>
    <h2>Kup teraz:</h2>
    <div style="text-align: center; margin: 40px auto 20px auto;">
        <a target="_blank" href="{base_url}produkt/{slug_name}/{product_id}" style="background-color: #19a299; padding: 15px; color: #fff; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15);">KLIKNIJ
            TUTAJ</a>
    </div>
</div>