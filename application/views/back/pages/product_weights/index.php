    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody mg-t-0 pd-x-30">
            <h4 class="pb-2">Integracja malfini wybiera słowa-klucze, na podstawie których przypisuje wagi. System
                wybierze
                największą wagę spośród słów kluczowych, np. dla słowa "spodnie" z wagą 0.4kg i słowa "ogrodniczki" z
                wagą
                0.5kg system ustali wagę 0.5kg. Proszę
                unikać
                polskich
                znaków oraz znaków specjalnych, gdyż system zwyczajnie je pominie.</h4>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="wd-50p text-right no-sort">
                                <a href="<?php echo base_url(); ?>panel/<?= basename(__DIR__) ?>/form/insert"
