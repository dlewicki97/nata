    ...
    <div class="br-mainpanel">
        <div class="pd-30">
            <h4 class="tx-gray-800 mg-b-5"><?= $filter->title ?> - Lista</h4>
        ...
        <div class="br-pagebody mg-t-0 pd-x-30">
            ...
            <form class="form-layout form-layout-2"
                action="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/action/<?php echo $this->uri->segment(4) . '/' . $this->uri->segment(2); ?>/<?php echo $filter->id . '/' . @$value->id; ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-r-0-force bd-t-0-force">
                                    <label class="form-control-label mg-b-0-force">Filtr: <span
                                            class="tx-danger">*</span></label>
                                    <select id="select2-a" class="form-control select2-show-search" name="filter_id"
                                        data-placeholder="Wybierz filtr" required>
                                        <?php foreach ($filters as $f) : ?>
                                        <option value="<?= $f->id ?>"
                                            <?php if (isSelected($filter->id, $f->id, @$value)) echo 'selected'; ?>>
                                            <?= $f->title ?>
                                        </option>
                                        <?php endforeach; ?>
