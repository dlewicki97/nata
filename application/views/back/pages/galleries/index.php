    ...
    <div class="br-mainpanel">
      <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Galerie</h4>
            ...
            <thead>
              <tr>
                ...
                <th class="wd-50p text-right no-sort">
                  <a href="<?php echo base_url(); ?>panel/<?= basename(__DIR__) ?>/form/insert" class="btn btn-sm btn-info"><i class="fa fa-plus mg-r-10"></i> Dodaj</a>
                </th>
              </tr>
            </thead>
            <tbody>
