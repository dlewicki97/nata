                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force">
                                <label class="form-control-label">Adres URL: <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="address_url" value="<?php echo @$value->address_url; ?>" required>
                            </div>
                        </div><!-- col-4 -->
                    </div> <!-- set -->
                    <div class="row"> <!-- set -->
                        <div class="col-md-6 pr-0">
                            <div class="form-group bd-t-0-force bd-b-0-force">
                                <label class="form-control-label">Kolejność: <span class="tx-danger">*</span></label>
                                <input class="form-control" type="number" name="priority" value="<?php echo @$value->priority; ?>" required>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-t-0-force bd-b-0-force bd-l-0-force">
                                <label class="form-control-label">Aktywna: <span class="tx-danger">*</span></label>
                                <select class="form-control select2" name="active" required>
                                    <option <?php if(@$value->active == 0){echo 'selected';} ?> value="0">Nie</option>
                                    <option <?php if(@$value->active == 1){echo 'selected';} ?> value="1">Tak</option>
                                </select>
                            </div>
                        </div><!-- col-4 -->
                    </div> <!-- set -->
