        ...
        <div class="br-pagebody mg-t-0 pd-x-30">
            ...
            <form class="form-layout form-layout-2"
                ...
                <div class="row no-gutters">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group bd-t-0-force bd-b-0-force">
                                    <label class="form-control-label">Tekst na przycisku:</label>
                                    <input class="form-control" type="text" name="txt_btn"
                                        value="<?php echo @$value->txt_btn; ?>">
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-md-6 px-0">
                                <div class="form-group bd-t-0-force bd-b-0-force bd-l-0-force bd-r-0-force">
                                    <label class="form-control-label">Adres URL:</label>
                                    <input class="form-control" type="text" name="txt_url"
                                        value="<?php echo @$value->txt_url; ?>">
                                </div>
                            </div><!-- col-4 -->
                        </div> <!-- set -->
                        <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="col-md-12">
                            <div id="photoViewer_1" class="form-group  text-center delete_photo cursor"
                                onclick="clear_box(1);">
                                <?php if (@$value->photo != '') {
