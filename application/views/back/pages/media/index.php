            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-45p align-top">Link</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle"><?php if($value->title != ''){echo $value->title;} else{echo $value->name;} ?></td>
                  <td class="align-middle"><?php echo base_url(); ?>uploads/<?php echo date('Y-m-d', strtotime($value->created)); ?>/<?php echo $value->name; ?></td>
                  <td class="text-right">
