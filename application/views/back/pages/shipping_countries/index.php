            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-45p align-top">Kod</th>
                  <th class="wd-45p align-top">Nazwa kraju</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle"><?php echo $value->code; ?></td>
                  <td class="align-middle"><?php echo $value->country; ?></td>
                  <td class="text-right">
                      ...
                      onclick="return confirm('Czy na pewno chcesz usunąć <?php echo $value->country; ?>? #<?php echo $value->id; ?>')" >
