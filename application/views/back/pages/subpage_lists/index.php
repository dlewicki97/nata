    ...
    <div class="br-mainpanel">
        <div class="pd-30">
            ...
            <a href="<?php echo base_url(); ?>panel/subpages" class="btn btn-sm btn-info mt-3"><i
        ...
        <div class="br-pagebody mg-t-0 pd-x-30">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="wd-50p text-right no-sort">
                                <a href="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/form/insert/<?= $subpage->id; ?>"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a href="<?php echo base_url(); ?>panel/<?php echo $this->uri->segment(2); ?>/form/update/<?= $subpage->id; ?>/<?php echo $value->id; ?>"
            ...
            function changeOrder(id) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url(); ?>panel/subpage_lists/priority",
                    data: {
                        id: id,
                        priority: priority
                    },
