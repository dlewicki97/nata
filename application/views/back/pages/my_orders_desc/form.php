                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force">
                                    <label class="form-control-label">Dane klienta:</label>
                                    <input class="form-control" type="text" name="client_data"
                                        value="<?php echo @$value->client_data; ?>">
                                </div>
                            </div>
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force">
                                    <label class="form-control-label">Produkty:</label>
                                    <input class="form-control" type="text" name="products"
                                        value="<?php echo @$value->products; ?>">
                                </div>
                            </div>
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force">
                            ...
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force">
                                    <label class="form-control-label">Przesyłka:</label>
                                    <input class="form-control" type="text" name="shipping"
                                        value="<?php echo @$value->shipping; ?>">
                                </div>
                            </div>
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-t-0-force">
                                    <label class="form-control-label">Razem:</label>
                                    <input class="form-control" type="text" name="sum"
                                        value="<?php echo @$value->sum; ?>">
                                </div>
                            </div>
                        </div>
