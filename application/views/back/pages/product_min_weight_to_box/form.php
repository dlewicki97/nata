    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody mg-t-0 pd-x-30">
            ...
            <h4 class="mb-3">Minimalna waga produktu, od której algorytm zaczyna naliczać kartony w koszyku. Produkty o
                wadze niżej
                niż poniżej podana zostaną brane pod uwagę jako "reszta z kartonów".</h4>
