                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group bd-t-0-force bd-b-0-force">
                                    <label class="form-control-label">Kolejność: <span
                                            class="tx-danger">*</span></label>
                                    <input class="form-control" type="number" name="priority"
                                        value="<?php echo @$value->priority; ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6 px-0">
                                <div class="form-group bd-t-0-force bd-b-0-force bd-l-0-force">
                                    ...
                                    <select class="form-control select2" name="active" required>
                                        <option <?php if (@$value->active == 0) {
                                                    echo 'selected';
                                                } ?> value="0">Nie</option>
                                        <option <?php if (@$value->active == 1) {
                                                    echo 'selected';
                                                } ?> value="1">Tak</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-12 pr-0">
                                <div class="form-group bd-b-0-force">
                                    ...
                                    <textarea class="form-control" rows="6"
                                        name="short_desc"><?php echo @$value->short_desc; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group bd-t-0-force bd-l-0-force">
                                <a href="<?php echo base_url(); ?>panel/settings/gallery/<?php echo $this->uri->segment(2); ?>/<?php echo $value->id; ?>"
                                    class="btn btn-sm btn-secondary btn-block"><i class="icon ion-images mg-r-10"></i>
                                    Galeria</a>
                            </div>
                        </div><!-- col-12 -->
                        <?php endif; ?>
