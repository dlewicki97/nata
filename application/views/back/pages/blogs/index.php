            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle">
                    <img src="<?= base_url('uploads/'.$value->photo); ?>" width="64" style="max-height: 48px;">
                    <?php echo $value->title; ?>
                  </td>
                  <td class="align-middle">
                      <input class="form-control" id="getOrder<?php echo $value->id; ?>"
                      name="priority" onchange="changeOrder(<?php echo $value->id; ?>, '<?php echo $this->uri->segment(2); ?>')"
    ...
    <script type="text/javascript">
      ...
      function changeOrder(id, table) {
          ...
          $.ajax({
              ...
              data: {id:id, priority:priority, table:table},
              cache: false,
              complete: function(html) {
                  console.log(html);
