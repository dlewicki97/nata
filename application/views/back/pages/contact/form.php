            ...
            <div class="row no-gutters">
                <div class="col-md-8">
                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force">
                                <label class="form-control-label">Kontakt: <span class="tx-danger">*</span></label>
                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-6 pr-0">
                            <div class="form-group bd-t-0-force">
                                <label class="form-control-label">Numer telefonu 1:</label>
                                <input class="form-control" type="text" name="phone1" value="<?php echo @$value->phone1; ?>">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-t-0-force bd-l-0-force">
                                <label class="form-control-label">Numer telefonu 2:</label>
                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-6 pr-0">
                            <div class="form-group bd-t-0-force bd-b-0-force">
                                <label class="form-control-label">Adres e-mail 1:</label>
                                <input class="form-control" type="text" name="email1" value="<?php echo @$value->email1; ?>">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-t-0-force bd-b-0-force bd-l-0-force">
                                <label class="form-control-label">Adres e-mail 2:</label>
