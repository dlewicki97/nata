<section class="single-service">
    ...
    <div class="d-flex flex-wrap">
        <a class="w-100" data-lightbox="service" href="<?= base_url('uploads/' . $service->photo) ?>">
            <div data-bg="<?= base_url('uploads/' . $service->photo) ?>" alt="<?= $service->alt ?>" class="lazy bg" style="height: 400px"></div>
        </a>
        ...
        <div class="d-flex flex-wrap w-100 mt-4">
            <?php foreach ($gallery as $photo) : ?>
                <div class="col-12 col-lg-4">
                    <a data-lightbox="service" href="<?= base_url('uploads/' . $photo->photo) ?>">
