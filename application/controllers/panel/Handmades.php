...
class Handmades extends CI_Controller
{
	...
	{
		$this->back_m->update($_POST['table'], ['home' => $_POST['value']], $_POST['id']);
	}
	public function menu()
	{
		$this->back_m->update($_POST['table'], ['menu' => $_POST['value']], $_POST['id']);
	}
	public function home_order()
	{
		$this->back_m->update($_POST['table'], ['home_order' => $_POST['value']], $_POST['id']);
	}
